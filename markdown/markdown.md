...
1. [Introdução ao Markdown](#introdução-ao-markdown)
2. [Formatação de Texto](#formatação-de-texto)
   - 2.1 [Títulos](#títulos)
   - 2.2 [Negrito e Itálico](#negrito-e-itálico)
   - 2.3 [Links](#links)
   - 2.4 [Listas](#listas)
   - 2.5 [Listas de Tarefas](#listas-de-tarefas)
   - 2.6 [Tachado](#tachado)
   - 2.7 [Fórmulas Matemáticas](#formulas-matematicas)
     - 2.7.1 [Equações em Linha](#equacoes-em-linha)
     - 2.7.1 [Equações em Bloco](#equacoes-em-bloco)
3. [Inserção de Mídia](#inserção-de-mídia)
   - 3.1 [Imagens](#imagens)
   - 3.2 [Vídeos](#vídeos)
4. [Citações](#citações)
5. [Linhas Horizontais](#linhas-horizontais)
6. [Código Embutido](#código-embutido)
7. [Blocos de Código](#blocos-de-código)
8. [Tabelas](#tabelas)
9. [Notas de Rodapé](#notas-de-rodape)
